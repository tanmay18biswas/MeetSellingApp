...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if($numExistRows > 0){
    ...
    if(($password == $cpassword)){
      $sql = "INSERT INTO `users1` (`username`,`phone`,`email`, `password`, `date`) VALUES ('$username','$phone','$email', '$password', current_timestamp())";
        ...
        <div class="container-xl">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-4">
                    <h1 class="font-weight-bold my-3">Sign Up</h1>
                    <form action="/Login_system1/signup.php" method="post">
                        ...
                        <div class="form-row col-lg-7 mt-4">
                            ...
                            <input type="number" maxlength="10" placeholder="Enter Phone no." class="form-control mb-3" id="phone" name="phone">
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                <button type="submit" class="btn1 my-3">Sign Up</button>
                            </div>
                        </div>
