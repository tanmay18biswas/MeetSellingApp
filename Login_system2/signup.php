  ...
  <?php
    ...
    if($emailcount>0){
        ...
        if($password === $cpassword){
            $insertquery = "insert into `registration` (username, email, mobile, password, cpassword, token, status, date) 
            values('$username', '$email','$mobile','$pass','$cpass','$token','inactive', current_timestamp())";
            ...
            if($iquery){
                ...
                http://localhost:8080/Login_system2/activate.php?token=$token";
        ...
        <div class="container-xl">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-4">
                    ...
                    <form action="/Login_system2/signup.php" method="post">
