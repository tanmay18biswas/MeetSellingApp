    ...
    if($num > 0)
    {
        while($products = mysqli_fetch_array($queryfire)){
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                <form>
                    <div class="card">
                        <h6 class="card-title bg-danger text-white p-2 text-uppercase"> <?php echo $products['Product_Name'];?></h6>
                        <div class="card-body">
                        ...
                        <!--button start-->
                        <div class="btn d-flex text">
                        <button class="btn btn-info flex-fill" style="width: ;"><a href="/Front-end/cart.php" class="text-white" >Just Check</a></button>
