...
<div class="card p-4">
<h2 class="py-4 font-weight-bold">Chicken LEG</h2>
<div class="row">
<!-- cart images div -->
...
<h1 class="mb-4 product_name">Chicken Leg</h1>
<p class="mb-2">Pieces - 6psc</p>
<p class="mb-2">Weight: 500gm</p>
<p class="mb-3">With skin: Yes</p>
</div>
<!-- quantity inc dec -->
<div class="col-6">
...
<!-- cart images div -->
<div class="col-md-5 col-11 mx-auto bg-light d-flex justify-content-center align-items-center shadow product_img">
<img src="img/11.webp" class="img-fluid" alt="cart img">
</div>
<!-- cart product details -->
<div class="col-md-7 col-11 mx-auto px-4 mt-2">
<div class="row">
<!-- product name  -->
<div class="col-6 card-title">
<h1 class="mb-4 product_name">Ready to cook Chicken Leg</h1>
<p class="mb-2">Pieces - 6psc</p>
<p class="mb-2">Weight: 500gm</p>
<p class="mb-3">With skin: no</p>
</div>
<!-- quantity inc dec -->
<div class="col-6">
<ul class="pagination justify-content-end set_quantity">
...
<button class="btn btn-primary text-uppercase" onclick="openPopup()">Place Order</button>
<div class="popup" id="popup">
    <img src="img/checkmark_png.png">
    <h2>Thank You</h2>
...
<small id="error_trw" class="text-dark mt-3">code is cookruku18</small>
</div>
...
product_total_amt.innerHTML  = parseInt(product_total_amt.innerHTML) - 150;
...
if(discountCode.value === 'cookruku18'){
let newtotalamt = totalamtcurr - 50;
total_cart_amt.innerHTML = newtotalamt;
error_trw.innerHTML = "Hurray! code is valid";
}else{
error_trw.innerHTML = "Try Again! Valid code is cookruku18";
}
}
