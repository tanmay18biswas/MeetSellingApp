...
<html lang="en">
  <head>
    ...
    <title>User Welcome - <?php $_SESSION['username']?></title>
  </head>
  <body>
    ...
    <div class="container my-4">
          <div class="alert alert-success" role="alert">
              ...
              <hr>
              <p class="mb-0">Whenever you need to, be sure to logout <a href="/Register_User/user_logout.php"> using this link.</a></p>
          </div>
    </div>
