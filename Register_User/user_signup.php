...
<html lang="en">
  ...
  <?php
    ...
    $emailquery = " select * from `register_user` where User_Email='$email' ";
    ...
    if($emailcount>0){
        ...
        if($password === $cpassword){
            $insertquery = "insert into `register_user` (User_Name, User_Email, User_phnno, Password, Token, Status, User_Add, User_pincode, date) 
            ...
            if($iquery){
                ...
                http://localhost:8080/Register_User/user_activate.php?token=$token";
        ...
        <div class="container-xl">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-4">
                    <h1 class="font-weight-bold my-3">User Sign Up</h1>
                    <form action="/Register_User/user_signup.php" method="post">
