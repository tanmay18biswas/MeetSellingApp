...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $email_search = "Select * from `register_user` where `User_Email` ='$email' and Status='active'";
        ...
        <div class="container-xl" style=" margin-top: 4rem;">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    <h1 class="font-weight-bold py-3">User Log In</h1>
                ...
                <form action="/Register_User/user_login.php" method="post">
                        ...
                        <a href="user_forgot_password.php">Frogot password</a>
