...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $email_search = "Select * from `admin` where `Admin_Email` ='$email' and Status='active'";
...
if($email_count){
      ...
      $_SESSION['username'] = $email_pass['Admin_Name'];
      $pass_decode = password_verify($password, $db_pass);
            if($pass_decode){
                ...
                header("location: choose_update.php");
            }
        ...
        <div class="container-xl" style=" margin-top: 4rem;">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    <h1 class="font-weight-bold py-3">Admin Log In</h1>
                ...
                <form action="/Admin/admin_login.php" method="post">
                        ...
                        <a href="forgot_password.php">Frogot password</a>
