  ...
  <body>
                ...
                if(isset($_POST['submit'])){
                        ...
                        if(isset($_GET['id'])){
                                ...
                                $updatequery = " update `supplier` set Supplier_Name='$newname' where Supplier_ID='$id' ";
                                ...
                                $iquery = mysqli_query($conn, $updatequery);
                                        ...
                                        header('location:update_name1.php');
                                        }
        ...
        <div class="container-xl">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-4">
                    <h1 class="font-weight-bold my-3">Update Name</h1>
