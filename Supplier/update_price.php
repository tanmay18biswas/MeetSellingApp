  ...
  <body>
                ...
                if(isset($_POST['submit'])){
                        ...
                        if(isset($_GET['id'])){
                                ...
                                $updatequery = " update `product` set Price='$newname' where Product_ID='$id' ";
                                ...
                                $iquery = mysqli_query($conn, $updatequery);
                                        ...
                                        header('location:update_price.php');
                                        }
        ...
        <div class="container-xl">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-4">
                    <h1 class="font-weight-bold my-3">Update Product Price</h1>
                    
                    <form action="" method="post">
                        
                        <div class="form-row col-lg-7">
                            <label for="password" class="form-label mt-4">Enter New Price</label>
                            <input type="name" placeholder="New Price" class="form-control mb-3" id="name" name="newname">
                        </div>
