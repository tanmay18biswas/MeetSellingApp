...
<html lang="en">
  ...
  <?php
    ...
    $emailquery = " select * from `supplier` where Supplier_Email='$email' ";
    ...
    if($emailcount>0){
        ...
        if($password === $cpassword){
            $insertquery = "insert into `supplier` (Supplier_Name, Supplier_Email, Supplier_phnno, Password, Token, Status, Supplier_Add, Supplier_pincode, date) 
            values('$username', '$email','$mobile','$pass','$token','inactive', '$add', '$pin', current_timestamp())";
            ...
            if($iquery){
                ...
                http://localhost:8080/Supplier/supplier_activate.php?token=$token";
        ...
        <div class="container-xl">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-4">
                    <h1 class="font-weight-bold my-3">Supplier Sign Up</h1>
                    <form action="/Supplier/supplier_signup.php" method="post">
                        ...
                        <div class="form-row col-lg-7">
                            ...
                            <input type="text" placeholder="Address" class="form-control mb-3" id="address" name="address">
                            <div id="emailHelp" class="form-text">Please fill the correct address</div>
                        </div>

                        <div class="form-row col-lg-7">
                            <label for="pincode" class="form-label mt-4">Pincode</label>
                            <input type="code" placeholder="eg-700008" class="form-control mb-3" id="pincoded" name="pincode">
                        </div>
                        ...
                        <div class="form-row">
                         ...
                         <a href="supplier_login.php">Log In here</a>
                    </form>
                </div>
            </div>
        </div>
