  ...
  <body>
                ...
                if(isset($_POST['submit'])){
                        ...
                        if(isset($_GET['id'])){
                                ...
                                $updatequery = " update `product` set image='$newname' where Product_ID='$id' ";
        ...
        <div class="container-xl">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-4">
                    <h1 class="font-weight-bold my-3">Update Product Image</h1>
                    
                    <form action="" method="post">
                        
                        <div class="form-row col-lg-7">
                            <label for="password" class="form-label mt-4">Enter Image Path</label>
                            <input type="name" placeholder="image.jpg,png,jpeg,webp" class="form-control mb-3" id="name" name="newname">
                        </div>
