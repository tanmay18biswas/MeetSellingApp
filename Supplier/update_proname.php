                ...
                if(isset($_POST['submit'])){
                        ...
                        if(isset($_GET['id'])){
                                ...
                                $iquery = mysqli_query($conn, $updatequery);
                                        ...
                                        header('location:update_proname.php');
                                        }
        ...
        <div class="container-xl">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-4">
                    <h1 class="font-weight-bold my-3">Update Product Name</h1>
                    
                    <form action="" method="post">
                        
                        <div class="form-row col-lg-7">
                            <label for="password" class="form-label mt-4">Enter New Name</label>
                            <input type="name" placeholder="New Name" class="form-control mb-3" id="name" name="newname">
                        </div>
